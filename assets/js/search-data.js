...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        },{id: "post-computational-implementation-of-the-jacobian-matrix-for-implicit-non-linear-fem-analyses",
        ...
        handler: () => {
            ...
            window.location.href = "/blog/2026/Jacobian-FEM-Implicit/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/CV_toni.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61.%64%65%6C%65%6F@%6D%65.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/tonideleo", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=-X6GqMsAAAAJ", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.researchgate.net/profile/Antonio-Alessandro-Deleo/", "_blank");
        },
      },{
      id: 'light-theme',
